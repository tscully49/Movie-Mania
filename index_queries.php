<?PHP
    ...
    $box_office_query = pg_prepare($conn, "total_box_office", 'SELECT rank() OVER (ORDER BY domestic_gross DESC) AS total_gross, title, release_date, domestic_gross FROM movie LIMIT 10');
