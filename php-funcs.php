...
function print_all_genres() { // Functions which prints out a table for each genres and displays 10 movies from that genres in the table 
    ...
    $this_genre = pg_prepare($conn, "genre_query", 'SELECT genre FROM genre');
    $this_genre = pg_execute($conn, "genre_query", array());
		...
		echo"\n<div class='col-lg-3'>";
		    echo"\n\t<div class='panel panel-default'>";
		        echo"\n\t\t<div class='panel-heading'>";
		            echo"\n\t\t\t<h3 class='panel-title'><i class='fa fa-tasks fa-fw'></i><strong> $all_genres Movies</strong></h3>"; 
		        echo"\n\t\t</div>";
		        echo"\n\t\t<div class='panel-body'>";
		        	...
		        	echo"\n\t\t\t<div class='text-right'>";
		                echo"\n\t\t\t\t<a href='#'>View All $all_genres Movies <i class='fa fa-arrow-circle-right'></i></a>";
		            echo"\n\t\t\t</div>";
		        echo"\n\t\t\t</div>";
		    echo"\n\t\t</div>";
		echo"\n\t</div>";
