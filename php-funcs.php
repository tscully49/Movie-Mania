		                    ...
		                    echo"\n\t\t\t\t\t<tbody>";
		                        ...
		                        while ($info = pg_fetch_array($this_genre, null, PGSQL_ASSOC)) {
		                            ...
		                            foreach($info as $col) { // Prints out all the info 
		                            	echo"\n\t\t\t\t\t\t<td id='this_thing'><form action='movies.php' method='post'><input type='submit' name='submit' value='$col' class='list-group-item btn btn-default id' id='this-one'></input></form></td>";
		                            }
		                            echo"\n\t\t\t\t\t\t</tr>";
		                        }
                        ...
                        echo"\n\t\t\t\t\t<tbody>";
                            ...
                            while ($movies = pg_fetch_array($this_genre, null, PGSQL_ASSOC)) {
                                ...
                                foreach($movies as $col) { // Prints out all the info 
                                    ...
                                    if ($number == 1) {
	                                    echo"\n\t\t\t\t\t\t\t<td id='this_thing'><form action='movie_profile.php' method='post'><input type='submit' name='submit' value='$col' class='list-group-item btn btn-default id' id='this-one'></input></form></td>";
                                	}
                                	else {
